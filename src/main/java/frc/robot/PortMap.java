...
public class PortMap {
    ...
    public static final int LEFT_FRONT_SPARK = 60; 
    public static final int LEFT_MIDDLE_SPARK = 50; 
    public static final int LEFT_BACK_SPARK = 40;

    public static final int RIGHT_FRONT_SPARK = 30;
    public static final int RIGHT_MIDDLE_SPARK = 20;
